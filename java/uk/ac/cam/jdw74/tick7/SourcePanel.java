...
public abstract class SourcePanel extends JPanel {
    ...
    public SourcePanel() {
        ...
        JRadioButton library =
            new JRadioButton(Strings.BUTTON_SOURCE_LIBRARY, true);
        JRadioButton fourStar =
            new JRadioButton(Strings.BUTTON_SOURCE_FOURSTAR, true);
        ...
        none.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    if (setSourceNone())
                        //successful: none found and patterns loaded
                        current = none;
                    else
